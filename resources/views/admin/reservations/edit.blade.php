...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading"><h1>ویرایش رزرو #{{ $reservation->user['email']}} : {{  jDate::forge($reservation->date_reserved)->format('date') }} : {{ $reservation->time_reserved }}</h1></div>
        <div class="panel-body">
            ...
            <div>
                ...
                @include ('admin.reservations.form', ['submitButtonText' => 'ویرایش'])
